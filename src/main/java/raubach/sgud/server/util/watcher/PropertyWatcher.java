...
package raubach.sgud.server.util.watcher;
...
import raubach.sgud.server.util.CollectionUtils;
...
public class PropertyWatcher
{
	...
	{
		throw new RuntimeException("SGUD failed to start: Non-optional property not set: '" + property.getKey() + "'");
	}
