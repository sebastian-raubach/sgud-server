...
import raubach.sgud.server.database.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    private static final long serialVersionUID = 901458334;

    /**
     * The reference instance of <code>sgud.schema_version</code>
     */
    ...
    /**
     * The column <code>sgud.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>sgud.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>sgud.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>sgud.schema_version.installed_on</code>.
     */
    ...
    /**
     * The column <code>sgud.schema_version.execution_time</code>.
     */
    ...
    /**
     * The column <code>sgud.schema_version.success</code>.
     */
    ...
    /**
     * Create a <code>sgud.schema_version</code> table reference
     */
    ...
    /**
     * Create an aliased <code>sgud.schema_version</code> table reference
     */
    ...
    public UniqueKey<SchemaVersionRecord> getPrimaryKey() {
        return Internal.createUniqueKey(raubach.sgud.server.database.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", raubach.sgud.server.database.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK);
    }
    ...
    public List<UniqueKey<SchemaVersionRecord>> getKeys() {
        return Arrays.<UniqueKey<SchemaVersionRecord>>asList(
              Internal.createUniqueKey(raubach.sgud.server.database.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", raubach.sgud.server.database.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK)
        );
    }
